...
# PROMPT
SPACESHIP_PROMPT_OPEN_BRACE="${SPACESHIP_PROMPT_SYMBOL:- }"
SPACESHIP_PROMPT_CLOSE_BRACE="${SPACESHIP_PROMPT_SYMBOL:- }"
...
PROMPT="$PROMPT$SPACESHIP_PROMPT_OPEN_BRACE"'$(spaceship_build_prompt)'"$SPACESHIP_PROMPT_CLOSE_BRACE"
